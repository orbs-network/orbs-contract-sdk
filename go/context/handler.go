...
type SdkHandler interface {
	...
	SdkEthereumGetLog(ctx ContextId, permissionScope PermissionScope, contractAddress string, jsonAbi string, ethTransactionId string, eventName string, out interface{})
